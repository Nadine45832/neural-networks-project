...
# features and target
X = df.drop(columns=["Second_Term_GPA", "DropoutFlag"])
y = df["DropoutFlag"]
...
dropout_model = keras.Sequential([
    layers.Dense(128, activation="relu", input_shape=(X_train_proc.shape[1],)),
    layers.Dropout(0.3),
...
callbacks = [
    ...
    keras.callbacks.ModelCheckpoint("best_dropout_model.keras", save_best_only=True)
]
...
"""
# saving model
dropout_model.save(r"C:\Users\josep\Downloads\dropout_probability_model2.keras")
